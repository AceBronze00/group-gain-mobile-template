...
import { Users, DollarSign, Calendar, Check, X, Bell, History, CheckCircle, XCircle, ArrowUpRight, Wallet, Clock } from "lucide-react";
...
const ActivityTab = () => {
  ...
  // Recent transactions data (moved from WalletTab)
